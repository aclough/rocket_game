# Rocket Tycoon Roadmap — MVP era (archived)

> **Frozen 2026-09-01, at the end of M5.** This is the roadmap as it
> stood while M1–M5 were being built, kept for the per-milestone task
> breakdowns and the harness findings that drove the M4 balance pass.
> The living roadmap is `ROADMAP.md` in the repo root; it drops the
> completed milestone detail and keeps what's ahead.
