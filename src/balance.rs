...
pub fn design_work_required(complexity: u32) -> f64 {
    let base_days = 120.0;
...
mod tests {
    ...
    #[test]
    fn test_design_work_required() {
        // complexity 5 → 120 * 1.0 = 120
        assert!((design_work_required(5) - 120.0).abs() < 0.01);
        // complexity 6 → 120 * 1.2 = 144
