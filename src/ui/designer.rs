//! The rocket designer: its state, the tank autosizer and structural
//! mass solver, and the key handling for building a vehicle stage by
//! stage (17_REFACTOR.md E1).
...
pub(super) fn recompute_structural_masses(stage_groups: &mut [Vec<Stage>]) {
